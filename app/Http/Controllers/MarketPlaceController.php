...
class MarketplaceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $response = Http::get(env('EXPRESS_API') . '/products', [
            'search' => $search
        ]);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $response = $kirim->post(env('EXPRESS_API') . '/products', [
                'name' => $request->name,
    ...
    public function show($id)
    {
        try {
            ...
            $response = Http::get(env('EXPRESS_API') . "/products/{$id}");
            ...
            if ($token) {
                ...
                $wishResponse = Http::withToken($token)->get(env('EXPRESS_API') . '/wishlist');
    ...
    public function destroy($id)
    {
        ...
        try {
            $response = Http::withToken($token)->delete(env('EXPRESS_API') . "/products/{$id}");
