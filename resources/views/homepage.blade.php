...
<body>
    ...
    <div class="stats">
        <div class="container">
            <div class="stat-item">
                <div class="number" id="stat-penduduk">2,456</div>
                <div class="label">Penduduk Nagrak</div>
            </div>
            <div class="stat-item">
                <div class="number" id="stat-produk">487</div>
                <div class="label">Produk Lokal</div>
            </div>
            <div class="stat-item">
                <div class="number" id="stat-pengrajin">156</div>
                <div class="label">Keluarga Pengrajin</div>
            </div>
            <div class="stat-item">
                <div class="number" id="stat-proyek">8</div>
